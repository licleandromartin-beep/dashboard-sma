  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <MetricCard label="Precio promedio $/ha" value="—" sub="Zonaprop" />
        <MetricCard label="Precio promedio $/m²" value="—" sub="Comparativa" />
        <MetricCard label="Gap publicado vs cierre" value="—" sub="Datos insuficientes" />
        <MetricCard label="Tamaño promedio" value="—" sub="Hectáreas" />
      </div>

      <TablePlaceholder title="Precios por Tamaño Campo" />

      <ChartPlaceholder title="Mapa: Ubicación + precio/ha" />
    </div>
  );
}
